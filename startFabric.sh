...
CC_SRC_PATH=/opt/gopath/src/github.com/chaincode/company
...
Next, use the company applications to interact with the deployed company contract.
The company applications are available in multiple programming languages.
